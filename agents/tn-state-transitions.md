...
- `tn-nemesis` — for deep logic and state inconsistency audit
- `tn-review` — for general code review of state-related changes
...
- You do not review consensus logic (tn-consensus-safety agent handles that)
- You do not review crypto (tn-crypto-correctness agent handles that)
